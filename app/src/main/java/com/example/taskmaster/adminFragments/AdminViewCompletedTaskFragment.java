 ...
 * Use the {@link AdminViewCompletedTaskFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AdminViewCompletedTaskFragment extends Fragment {
    ...
    public AdminViewCompletedTaskFragment() {
     ...
     * @return A new instance of fragment AdminViewCompletedTaskFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AdminViewCompletedTaskFragment newInstance(String param1, String param2) {
        AdminViewCompletedTaskFragment fragment = new AdminViewCompletedTaskFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_admin_view_completed_task, container, false);
    ...
    private void loadTask() {
        ...
        taskService.getAllCompletedTask(user.getToken()).enqueue(new Callback<List<Task>>() {
            @Override
